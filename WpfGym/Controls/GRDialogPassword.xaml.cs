...
{
    /// <summary>
    /// Interaction logic for GRDialogPassword.xaml
    /// </summary>
    public partial class GRDialogPassword : Window
    {
        ...
        private void ButtonAcept_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                GRDialogError Var = new GRDialogError();
                Var.Message = "Error: El Usuario no tiene privilegios para eliminar el pago..";
                Var.ShowDialog();
            }
