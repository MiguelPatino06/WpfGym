...
namespace PowerClub.DataAccess.Utils
{
    public class UnitWork<T> : IUnitOfWork<T> where T : DbContext, new()
    {
        ...
        private EntityFrameworkGenericFactory<TEntity, TKey> CreateFactoryCore<TEntity, TKey>() where TEntity : class
        {
            ...
            if (disposable != null)
            {
                ...
                {
                    return (EntityFrameworkGenericFactory<TEntity, TKey>)disposable;
                }
            ...
            try
            {
                ...
                var factory = (EntityFrameworkGenericFactory<TEntity, TKey>)factoryObj;
                if (factory != null)
                {
        ...
        {
            return typeof(EntityFrameworkGenericFactory<,>);
        }
